...
When the root scope is destroyed, text and effect will be destroyed alongside it, since they were created within it. count will be untouched and future updates to count will have no effect.
