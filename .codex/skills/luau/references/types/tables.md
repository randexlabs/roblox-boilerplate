...
Sealed tables are _inexact_ in that the table may have properties which are not mentioned in the type.
As a result, sealed tables support _width subtyping_, which allows a table with more properties to be used as a table with fewer properties.
