...
For people who like jargon, Luau now supports _Rank N Types_, where
previously it only supported Rank 1 Types.

## Bidirectional typechecking

Up until now, Luau has used _bottom-up_ typechecking. For example, for
...
What we want in this case is a mix of bottom-up and _top-down_ typechecking.
...
_bidirectional typechecking_, and means that tools like type-directed
