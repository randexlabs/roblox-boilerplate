# Recap: September & October 2022

Date: 2022-11-01

## Semantic subtyping

One of the most important goals for Luau is to avoid _false
positives_, that is cases where Script Analysis reports a type error,
...
positives has landed, _semantic subtyping_, which removes a class of false positives caused
